import { EXAMPLES_COUNTER_PLUS_ONE } from '@/pages/examples/redux/constants';

import { counterPlusOne, reducer } from '@/pages/examples/redux/counterPlusOne';
...
describe('examples/redux/counterPlusOne', () => {
  ...
  it('handles action type EXAMPLES_COUNTER_PLUS_ONE correctly', () => {
    ...
    const state = reducer(prevState, { type: EXAMPLES_COUNTER_PLUS_ONE });
