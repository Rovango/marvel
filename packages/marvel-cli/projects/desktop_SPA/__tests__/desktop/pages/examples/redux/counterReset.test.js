import { EXAMPLES_COUNTER_RESET } from '@/pages/examples/redux/constants';

import { counterReset, reducer } from '@/pages/examples/redux/counterReset';
...
describe('examples/redux/counterReset', () => {
  ...
  it('handles action type EXAMPLES_COUNTER_RESET correctly', () => {
    ...
    const state = reducer(prevState, { type: EXAMPLES_COUNTER_RESET });
