import { EXAMPLES_COUNTER_MINUS_ONE } from '@/pages/examples/redux/constants';

import {
  counterMinusOne,
  reducer,
} from '@/pages/examples/redux/counterMinusOne';

describe('examples/redux/counterMinusOne', () => {
  it('returns correct action by counterMinusOne', () => {
    expect(counterMinusOne()).toHaveProperty(
      'type',
  ...
  it('handles action type EXAMPLES_COUNTER_MINUS_ONE correctly', () => {
    ...
    const state = reducer(prevState, { type: EXAMPLES_COUNTER_MINUS_ONE });
    // Should be immutable
